...
My base directory is: `/home/erke9581/embeddedai-forclass`, and I will use `<basedir>` to indicate the base directory.


## For Hello World

### STEP 0) clone tflite repo
...
### Step 2(optional) ) Look in tflite-micro/tensorflow/lite/micro/examples/hello_world
