...
#include "testdata/matt_left_1000ms_audio_data.h"
#include "testdata/matt_no_1000ms_audio_data.h"
#include "testdata/matt_right_1000ms_audio_data.h"
#include "testdata/matt_silence_1000ms_audio_data.h"
#include "testdata/matt_stop_1000ms_audio_data.h"
#include "testdata/matt_up_1000ms_audio_data.h"
#include "testdata/matt_yes_1000ms_audio_data.h"
...
TfLiteStatus AudioProviderInitialize()
{
    ...
    std::copy_n(g_matt_left_1000ms_audio_data, g_matt_left_1000ms_audio_data_size, audio_data_buffer + start_sample);
    start_sample += g_matt_left_1000ms_audio_data_size;

    std::copy_n(g_matt_no_1000ms_audio_data, g_matt_no_1000ms_audio_data_size, audio_data_buffer + start_sample);
    start_sample += g_matt_no_1000ms_audio_data_size;

    std::copy_n(g_matt_right_1000ms_audio_data, g_matt_right_1000ms_audio_data_size, audio_data_buffer + start_sample);
    start_sample += g_matt_right_1000ms_audio_data_size;

    std::copy_n(g_matt_silence_1000ms_audio_data, g_matt_silence_1000ms_audio_data_size, audio_data_buffer + start_sample);
    start_sample += g_matt_silence_1000ms_audio_data_size;

    std::copy_n(g_matt_stop_1000ms_audio_data, g_matt_stop_1000ms_audio_data_size, audio_data_buffer + start_sample);
    start_sample += g_matt_stop_1000ms_audio_data_size;

    std::copy_n(g_matt_up_1000ms_audio_data, g_matt_up_1000ms_audio_data_size, audio_data_buffer + start_sample);
    start_sample += g_matt_up_1000ms_audio_data_size;

    std::copy_n(g_matt_yes_1000ms_audio_data, g_matt_yes_1000ms_audio_data_size, audio_data_buffer + start_sample);
    start_sample += g_matt_yes_1000ms_audio_data_size;
